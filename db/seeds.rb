...
EventType.create(name:'palestra', limit:1, package_id:1)
EventType.create(name:'visita', limit:1, package_id:1)
EventType.create(name:'minicurso', limit:1, package_id:1)
...
Package.create(title:'Ouro', description:'esse é o pacote ouro', price:50, limit:50)
Package.create(title:'Prata', description:'esse é o pacote prata', price:40, limit:50)
Package.create(title:'Bronze', description:'esse é o pacote bronze', price:30, limit:50)
